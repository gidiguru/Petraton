		...
		<header class="bg-gray-900 pattern">
			<div class="container px-6 mx-auto">
				<nav class="flex flex-col py-2 sm:flex-row sm:justify-between sm:items-center">
					<div>
						<a href="#" class="text-2xl font-semibold text-white hover:text-gray-300">Gidiguru's World</a>
					</div>
				...
				<div class="flex flex-col items-center py-6 md:h-128 md:flex-row">
					<div class="md:w-1/2">
						<h2 class="text-4xl font-semibold text-gray-100">Gidiguru's World</h2>
	
						<h3 class="text-2xl font-semibold text-gray-100">
							Welcome <span class="text-indigo-400">Friend</span>
						</h3>
	
						<p class="mt-3 text-gray-100">Journey with me on becoming a Blockchain Developer.</p>
					</div>
